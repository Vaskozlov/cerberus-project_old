    ...
    {
        {
            ...
            test(
                [&c_pair] { return !(c_pair == std::make_pair(10, 10)); },
                CERBLIB_LOCATION);

            const Pair<int, int> c_pair2 = c_pair;

            test([&c_pair, &c_pair2] { return !(c_pair == c_pair2); }, CERBLIB_LOCATION);
...

        {
            ...
            test([&c_pair, &pr2] { return !(c_pair == pr2); }, CERBLIB_LOCATION);
